...
export class AustralianNationalKennelCouncilService {
  ...
  async findAll(locale: string): Promise<AustralianNationalKennelCouncil[]> {
  ...
  async findOne(
    id: number,
    locale: string,
  ): Promise<AustralianNationalKennelCouncil | null> {
  ...
  private mapToEntity(
    ...
    const entity = new AustralianNationalKennelCouncil();
