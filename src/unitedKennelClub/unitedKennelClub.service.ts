...
export class UnitedKennelClubService {
  ...
  async findAll(locale: string): Promise<UnitedKennelClub[]> {
  ...
  async findOne(id: number, locale: string): Promise<UnitedKennelClub | null> {
  ...
  private mapToEntity(record: any, locale: string): UnitedKennelClub {
    const entity = new UnitedKennelClub();
